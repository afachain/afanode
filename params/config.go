...
var (
	...
	TestnetGenesisHash = common.HexToHash("0x6341fd3daf94b748c72ced5a5b26028f2474f5f00d824504e4fa37a75767e177")
)
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		Arbiter:             &ArbiterConfig{Period: 3, Epoch: 200},
	}
	...
	// AllArbiterProtocolChanges copies from AllCliqueProtocolChanges.
	AllArbiterProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, &ArbiterConfig{Period: 0, Epoch: 30000}}
...
// ArbiterConfig is the consensus engine configs for proof-of-staking based sealing.
...
// String implements the stringer interface, returning the consensus engine details.
func (c *ArbiterConfig) String() string {
	return "arbiter"
}
